<!--
Referência de sistema de design, não de marca. Uso: estudar espaçamento,
hierarquia tipográfica e disciplina visual — nunca copiar cor/fonte por
cima da marca real do cliente (isso vem de marca/design-guide.md).
Estilo: clean/minimalista, versátil — bom baseline neutro padrão quando
o cliente ainda não definiu identidade visual. Ver
templates/design/referencias/README.md.
Fonte: VoltAgent/awesome-design-md (MIT) — "interpretação inspirada",
não ativos proprietários da marca original.
-->
